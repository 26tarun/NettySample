...
public interface TenantStorage {
	...
	boolean addImageDetails(PhotoHeader photoHeader, PhotoPayload imageRequest, String uuid);

	Request findImageDetails(Request request);
	
	boolean deleteImage(Request request);
}
