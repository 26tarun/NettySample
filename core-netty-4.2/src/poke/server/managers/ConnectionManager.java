...
public class ConnectionManager {
	...
	public synchronized static void broadcast(Integer nodeId, Request req) {
		if (req == null)
			return;
		// Kartik changes
		//for (Channel ch : connections.values())
		Channel ch = connections.get(nodeId);
			ch.write(req);
	}
	...
	public static HashMap<Integer, Channel> getConnections() {
		return connections;
	}
}
